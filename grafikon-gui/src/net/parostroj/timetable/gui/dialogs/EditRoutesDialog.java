...
public class EditRoutesDialog extends javax.swing.JDialog {
    ...
    public void updateValues() {
        ...
        if (model.getDiagram() != null) {
            String prototype = "";
            for (Route r : model.getDiagram().getRoutes()) {
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        ...
        model.getDiagram().addRoute(newRoute);
        model.fireEvent(new ApplicationModelEvent(ApplicationModelEventType.ROUTES_MODIFIED, model,newRoute));
        // clear name
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        model.getDiagram().removeRoute((Route)routesList.getSelectedValue());
        ((DefaultListModel)routesList.getModel()).remove(routesList.getSelectedIndex());
        model.fireEvent(new ApplicationModelEvent(ApplicationModelEventType.ROUTES_MODIFIED, model,deletedRoute));
